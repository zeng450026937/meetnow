(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('debug'), require('axios'), require('md5')) :
  typeof define === 'function' && define.amd ? define(['exports', 'debug', 'axios', 'md5'], factory) :
  (global = global || self, factory(global.MeetNow = {}, global.debug, global.axios, global.md5));
}(this, (function (exports, debug, axios, md5) { 'use strict';
          ...
          polling = createPolling({
              ...
              onError: (data) => {
                  ...
                  if (data.message === 'Network Error') {
                      log$r('polling error while network error');
                      return;
                  }
  ...
  exports.fetchControlUrl = fetchControlUrl;
